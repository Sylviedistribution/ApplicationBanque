...
@section('contents')
    ...
    <div class="container">
        <h2 class="text-center">Formulaire nouveau client</h2><br>

        <div class="card col-md-8 mx-auto">
            <div class="card-body">
                <form action="{{ route('utilisateurs.store') }}" method="POST" class="user" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input name="cni" type="file" class="form-control-file @error('cni') is-invalid @enderror"
                    ...
                    <button type="submit" class="btn btn-primary btn-user btn-block">Creer</button>
                </form>
